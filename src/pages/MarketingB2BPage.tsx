...
/**
 * MarketingB2BPage - Use case page for Cross-Border B2B Payments
 * Google DeepMind-style aesthetic matching main landing page
 */
const MarketingB2BPage: React.FC = () => {
  ...
  const painPoints = [
    {
      problem: "3-5 day SWIFT transfers kill cash flow",
      solution: "10-second settlements. Pay suppliers instantly, anywhere.",
      icon: <Zap className="w-6 h-6" />
    },
    {
      problem: "$25-50 wire fees on every transaction",
      solution: "1% flat fee. Save thousands on international payments.",
      icon: <DollarSign className="w-6 h-6" />
    },
    {
      problem: "Currency conversion eats 3-5% margins",
      solution: "Stablecoins eliminate conversion. One global currency.",
      icon: <Banknote className="w-6 h-6" />
    },
    {
      problem: "Banks freeze accounts without notice",
      solution: "Non-custodial wallets. You control your funds 24/7.",
  ...
  const features = [
    {
      ...
      description: "Pay suppliers worldwide in 10 seconds. No SWIFT delays or weekend holds.",
      icon: <Zap className="w-12 h-12 text-[#4285F4]" />
    },
    {
      title: "Predictable Pricing",
      description: "1% flat fee. No hidden charges, no FX markups, no correspondent bank fees.",
      icon: <DollarSign className="w-12 h-12 text-[#4285F4]" />
    },
    {
      title: "Enterprise Security",
      description: "Multi-signature wallets, role-based access, and audit trails for compliance.",
      icon: <Lock className="w-12 h-12 text-[#4285F4]" />
    },
    {
      title: "24/7 Operations",
      description: "No banking hours. Process payments anytime, including weekends and holidays.",
  ...
  const benefits = [
    ...
    "Save 50-70% on international payment fees",
    "Eliminate currency conversion costs",
    "Access funds 24/7 without bank restrictions",
    "Reduce payment friction with global suppliers",
    "Automate treasury operations with APIs"
  ];
  ...
  const codeExample = `// PYMSTR B2B SDK - Cross-border payments
...
// Real-time webhook when payment settles
pymstr.on('payment.completed', (data) => {
  // Update accounting system instantly
  updateLedger(data.invoiceId, data.txHash);
});`;
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Google Sans', sans-serif" }}>
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 mb-8">
              <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center" style={{ border: '0.25px solid rgba(0, 0, 0, 0.05)', boxShadow: '0 1px 2px rgba(0, 0, 0, 0.03)' }}>
                <Building2 className="w-7 h-7 text-[#FF5914]" />
              </div>
              <span className="text-[#5F6368]" style={{ fontSize: '18px', fontWeight: 420 }}>Cross-Border B2B Payments</span>
            </div>
            ...
            <p className="text-2xl sm:text-3xl text-[#5F6368] mb-10 font-normal" style={{ lineHeight: '1.6' }}>
              0.5% fees vs banks' 3-7%. Smart contract escrows for security. Instant global settlements.
            </p>
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="text-center mb-20">
            <h2 className="text-5xl sm:text-6xl font-normal text-[#202124] mb-6" style={{ fontFamily: "'Google Sans', sans-serif", lineHeight: '1.2' }}>
              We Solve Real B2B Problems
            </h2>
            <p className="text-xl sm:text-2xl text-[#5F6368] max-w-3xl mx-auto font-normal" style={{ lineHeight: '1.6' }}>
              Stop waiting days for international payments. Start settling in seconds.
            </p>
          </div>
      ...
      {/* B2B Features - GOOGLE DEEPMIND STYLE 🌟 */}
      <section className="relative py-40 overflow-hidden" style={{ background: 'linear-gradient(to bottom, white, #F8F9FA)', fontFamily: "'Google Sans', sans-serif" }}>
        <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl sm:text-2xl text-[#5F6368] max-w-3xl mx-auto font-normal" style={{ lineHeight: '1.6' }}>
              Everything your business needs for global payments.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-5xl sm:text-6xl font-normal text-[#202124] mb-8" style={{ fontFamily: "'Google Sans', sans-serif", lineHeight: '1.2' }}>
                Why Global Businesses Choose PYMSTR
              </h2>
              <p className="text-xl sm:text-2xl text-[#5F6368] mb-10 font-normal" style={{ lineHeight: '1.6' }}>
                Join companies moving billions across borders instantly.
              </p>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl sm:text-2xl text-[#5F6368] font-normal" style={{ lineHeight: '1.6' }}>
              Start processing cross-border payments today.
            </p>
          </div>
          ...
          >
            ...
            <div className="bg-[#2D2D2D] px-6 py-4 flex items-center gap-2">
              ...
              <span className="ml-4 text-[#8A8A8A] text-sm font-mono">b2b-payments.ts</span>
            </div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-white/90 mb-12 font-normal" style={{ lineHeight: '1.6' }}>
              Join businesses moving billions across borders. No setup fees. No commitments.
            </p>
...
export default MarketingB2BPage;
