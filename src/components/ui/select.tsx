...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-full py-1.5 pr-8 pl-2 text-sm outline-hidden select-none transition-all duration-200",
        "text-gray-900 dark:text-[#F6F7F9]",
        "focus:bg-[rgba(117,117,117,0.1)] focus:text-[#757575] dark:focus:text-[#757575]",
    ...
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-[#757575]" />
        </SelectPrimitive.ItemIndicator>
      </span>
